...
export const CartProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <CartContext.Provider value={{ cart, setCart, addItemToCart, decrementItemFromCart, removeItemFromCart, updateItemQuantity, clearCart, totalCartItems, totalCartPrice, totalSavings }}>
      {children}
